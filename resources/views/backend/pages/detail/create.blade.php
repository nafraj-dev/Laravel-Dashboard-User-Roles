    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Add Access</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.detail.index') }}"> 
Accessess Detail</a></li>
                    <li><span>Add Access</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Add Access</h4>
                    ...
                    <form action="{{ route('admin.detail.store') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Save data</button>
                    </form>
                </div>
            </div>
        </div>
